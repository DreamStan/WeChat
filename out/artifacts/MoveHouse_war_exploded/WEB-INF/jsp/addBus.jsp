...
<head>
    ...
    <!-- Date Picker -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/bootstrap-datepicker.min.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/daterangepicker.css">
    <!-- bootstrap wysihtml5 - text editor -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/bootstrap3-wysihtml5.min.css">
...
<%--<c:choose>
    <c:when test=""><h3>请登录<br>页面将在<span id="num"></span>秒后返回</h3>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div id="addUser"  aria-labelledby="gridSystemModalLabel">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="gridSystemModalLabel">添加商家</h4>
                                </div>
                                <div class="modal-body">
                                    <div class="container-fluid">
                                        <form action="/addbus" enctype="multipart/form-data" method="post" class="form-horizontal">
                                            <div class="form-group">
                                                <label class="col-xs-3 control-label">管理人姓名：</label>
                                                <div class="col-xs-8 ">
                                                    <input type="text" name="userName" class="form-control input-sm duiqi"  placeholder="">
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <label for="sName" class="col-xs-3 control-label">商家名称：</label>
                                                <div class="col-xs-8 ">
                                                    <input type="text" name="busName" class="form-control input-sm duiqi" id="sName" placeholder="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-xs-3 control-label">商家LOGO：</label>
                                                <div class="col-xs-8 ">
                                                    <input type="file" name="busLogo" class="form-control input-sm duiqi" placeholder="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="sOrd" class="col-xs-3 control-label">服务范围：</label>
                                                <div class="col-xs-8">
                                                    <input type="text" name="busSer" class="form-control input-sm duiqi" id="sOrd" placeholder="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-xs-3 control-label">商家简介：</label>
                                                <div class="col-xs-8">
                                                    <textarea name="busIntroduction" class="form-control input-sm duiqi"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-xs-3 control-label">固定电话：</label>
                                                <div class="col-xs-8">
                                                    <input type="text" name="busFixedtelephone" class="form-control input-sm duiqi" placeholder="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-xs-3 control-label">移动电话：</label>
                                                <div class="col-xs-8">
                                                    <input type="text" name="busMobiletelephone" class="form-control input-sm duiqi" placeholder="">
                                                </div>
                                            </div>
...
<!-- jvectormap -->
<script src="${pageContext.request.contextPath}/static/js/jquery-jvectormap-1.2.2.min.js"></script>
<script src="${pageContext.request.contextPath}/static/js/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="${pageContext.request.contextPath}/static/js/jquery.knob.min.js"></script>
<!-- daterangepicker -->
...
<!-- Bootstrap WYSIHTML5 -->
<script src="${pageContext.request.contextPath}/static/js/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
